		...
		<div class="container">
			<div class="row">
				<div class="col">
					...
					<div class="custom-box-details bg-color-light custom-box-shadow-1 col-lg-6 ml-5 mb-5 mb-lg-4 float-right clearfix">
						...
						<div class="row">
							...
							<div class="col-md-7">
								<ul class="custom-list-style-1 p-0 mb-0">
									<li>
										<span class="text-color-dark">{{ $t('cv.skype') }}:</span>
					...
					<h2 class="text-color-quaternary font-weight-extra-bold text-uppercase">{{ $t('cv.about_me') }}</h2>
					...
					<a id="aboutMeMoreBtn" class="btn btn-tertiary text-uppercase custom-btn-style-1 text-1" href="#">{{ $t('cv.view_more') }}</a>
